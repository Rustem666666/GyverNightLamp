...
// --- МАТРИЦА -------------------------
#define CURRENT_LIMIT         (2000U)                       // Лимит потребления матрицы по току в миллиамперах, автоматически управляет яркостью (пожалей свой блок питания!) 0 – выключить лимит
